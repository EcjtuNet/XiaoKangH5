									...
									<div class="col-xs-6">
										<div class="form-group">
											...
											<div class="col-xs-7 no-padding overflow-hidden">
												<input type="text" id="name" placeholder="" value="<?php echo $_POST['name'];?>" maxlength="4" class="border-bottom" required="required" oninvalid="setCustomValidity('请输入姓名')" oninput="setCustomValidity('')">
											</div>	
										</div>
									</div>
									<div class="col-xs-6">
										<div class="form-group">
											...
											<div class="col-xs-7 no-padding overflow-hidden">
												<input type="text" id="grade" placeholder="" value="<?php echo $_POST['grade'];?>" maxlength="4" class="border-bottom" required="required" oninvalid="setCustomValidity('请输入年级')" oninput="setCustomValidity('')">
											</div>	
										</div>
									</div>
								</div>
								<div class="row">
									<div class="form-group form-down">
										...
										<div class="col-xs-8 no-padding overflow-hidden">
											<input type="text" id="say" placeholder="" class="border-bottom" style="width: 100%;">
										</div>	
									...
									<div class="form-up col-xs-12">
										<textarea class="form-control no-border" rows="4" maxlength="48" required="required" oninvalid="setCustomValidity('请输入入学宣言(48字内)')" oninput="setCustomValidity('')"><?php echo $_POST['message'];?></textarea>
									</div>
								</div>
							</form>
						</div>
